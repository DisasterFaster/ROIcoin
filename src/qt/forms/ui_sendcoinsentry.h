...
public:
    ...
    ROIcoinAmountField *payAmount_is;
    ...
    ROIcoinAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new ROIcoinAmountField(SendCoins);
        ...
        payAmount_is = new ROIcoinAmountField(SendCoins_UnauthenticatedPaymentRequest);
        ...
        payAmount_s = new ROIcoinAmountField(SendCoins_AuthenticatedPaymentRequest);
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The ROIcoin address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        ...
        lockperiod->setText(QApplication::translate("SendCoinsEntry", "12", 0));
        locklength->clear();
        locklength->insertItems(0, QStringList()
         << QApplication::translate("SendCoinsEntry", "Months", 0)
...
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less roicoins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the ROIcoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the ROIcoin network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
