...
#ifndef ROICOIN_MAIN_H
#define ROICOIN_MAIN_H
...
static const signed int MIN_BLOCKS_TO_KEEP = 720;

// Require that user allocate at least 550MB for block & undo files (blk???.dat and rev???.dat)
// At 1MB per block, 720 blocks = 720MB.
 ...
 * Pruning will never delete a block within a defined distance (currently 720) from the active chain's tip.
