...
public:
    ...
    void setupUi(QDialog *DepositCoinsDialog)
    {
        ...
        DepositCoinsDialog->resize(888, 510);
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 ROI"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 ROI"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 ROI"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 ROI"));
        ...
        customFee = new ROIcoinAmountField(frameFeeSelection);
        ...
        labelBalance->setText(QStringLiteral("123.456 ROI"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("DepositCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for ROIcoin transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("DepositCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for ROIcoin transactions than the network can process.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        sendButton->setText(QApplication::translate("DepositCoinsDialog", "Deposit ROI", 0));
#ifndef QT_NO_TOOLTIP
