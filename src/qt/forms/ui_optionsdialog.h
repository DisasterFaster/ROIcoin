...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        roicoinAtStartup = new QCheckBox(tabMain);
        roicoinAtStartup->setObjectName(QStringLiteral("roicoinAtStartup"));

        verticalLayout_Main->addWidget(roicoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        roicoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start ROI Coin - Core after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        roicoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start ROI Coin - Core on system login", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the ROIcoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the ROIcoin network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting ROI Coin - Core.", 0));
#endif // QT_NO_TOOLTIP
