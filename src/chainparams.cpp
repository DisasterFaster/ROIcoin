...
public:
    CMainParams() {
        ...
        genesis.nVersion 		= 1;
        genesis.nTime    		= 1507847062;
        genesis.nBits    		= 0x21000FFF;
        genesis.nNonce   		= 4294901760;
        genesis.nStartLocation 		= 252564;
        genesis.nFinalCalculation 	= 2111898273;
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000a4714fcb9d83ec65edc5aadc816f6220a6593349c757c471208e45b353d43"));
        assert(genesis.hashMerkleRoot == uint256S("0xfd143730e1e498a3d76d09557044cfbacef449cb5513c94bef489a82b17e14be"));


        vSeeds.push_back(CDNSSeedData("seed1.roi-coin.com", "159.203.91.200"));  //New York
        vSeeds.push_back(CDNSSeedData("seed2.roi-coin.com", "165.227.10.125"));  //San Francisco
	vSeeds.push_back(CDNSSeedData("seed3.roi-coin.com", "138.197.172.223")); //Toronto
	vSeeds.push_back(CDNSSeedData("seed4.roi-coin.com", "99.198.174.212"));  //Kansas City
	//vSeeds.push_back(CDNSSeedData("seed5.roi-coin.com", "seed5.roi-coin.com")); //Reserved
        ...
        checkpointData = (Checkpoints::CCheckpointData) {
            ...
            ( 0, uint256S("0x000a4714fcb9d83ec65edc5aadc816f6220a6593349c757c471208e45b353d43")),
            1507847062, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1507520089;
        genesis.nNonce = 10270927;
