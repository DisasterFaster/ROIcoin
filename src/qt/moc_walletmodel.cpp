...
QT_MOC_LITERAL(10, 136, 20), // "std::vector<COutput>"
QT_MOC_LITERAL(11, 157, 15), // "termDepositInfo"
QT_MOC_LITERAL(12, 173, 23), // "encryptionStatusChanged"
QT_MOC_LITERAL(13, 197, 6), // "status"
QT_MOC_LITERAL(14, 204, 13), // "requireUnlock"
...
QT_MOC_LITERAL(28, 366, 12), // "updateStatus"
QT_MOC_LITERAL(29, 379, 17), // "updateTransaction"
QT_MOC_LITERAL(30, 397, 17), // "updateAddressBook"
QT_MOC_LITERAL(31, 415, 7), // "address"
QT_MOC_LITERAL(32, 423, 5), // "label"
QT_MOC_LITERAL(33, 429, 6), // "isMine"
QT_MOC_LITERAL(34, 436, 7), // "purpose"
QT_MOC_LITERAL(35, 444, 19), // "updateWatchOnlyFlag"
QT_MOC_LITERAL(36, 464, 18) // "pollBalanceChanged"
    ...
    "termDepositInfo\0encryptionStatusChanged\0"
...
static const uint qt_meta_data_WalletModel[] = {
 ...
 // signals: name, argc, parameters, tag, flags
      ...
      18,    3,  100,    2, 0x06 /* Public */,
      24,    2,  107,    2, 0x06 /* Public */,
      26,    1,  112,    2, 0x06 /* Public */,

 // slots: name, argc, parameters, tag, flags
      28,    0,  115,    2, 0x0a /* Public */,
      29,    0,  116,    2, 0x0a /* Public */,
      30,    5,  117,    2, 0x0a /* Public */,
      35,    1,  128,    2, 0x0a /* Public */,
      36,    0,  131,    2, 0x0a /* Public */,

 // signals: parameters
    QMetaType::Void, 0x80000000 | 3, 0x80000000 | 3, 0x80000000 | 3, 0x80000000 | 3, 0x80000000 | 3, 0x80000000 | 3, 0x80000000 | 10,    4,    5,    6,    7,    8,    9,   11,
...
void WalletModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->balanceChanged((*reinterpret_cast< const CAmount(*)>(_a[1])),(*reinterpret_cast< const CAmount(*)>(_a[2])),(*reinterpret_cast< const CAmount(*)>(_a[3])),(*reinterpret_cast< const CAmount(*)>(_a[4])),(*reinterpret_cast< const CAmount(*)>(_a[5])),(*reinterpret_cast< const CAmount(*)>(_a[6])),(*reinterpret_cast< std::vector<COutput>(*)>(_a[7]))); break;
        ...
        {
            typedef void (WalletModel::*_t)(const CAmount & , const CAmount & , const CAmount & , const CAmount & , const CAmount & , const CAmount & , std::vector<COutput> );
...
// SIGNAL 0
void WalletModel::balanceChanged(const CAmount & _t1, const CAmount & _t2, const CAmount & _t3, const CAmount & _t4, const CAmount & _t5, const CAmount & _t6, std::vector<COutput> _t7)
{
